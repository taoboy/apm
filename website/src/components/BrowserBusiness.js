...
class BrowserBusiness extends Component {
    ...
    brobusiness = (index) => {
        ...
        browser.broBusiness({
            ...
            if (data.status == "success") {
                this.setState({
                    tableData: data.webBusiness.rows,
                    currentPage: index,
                    tableDataCount: data.webBusiness.count
                })
            }
        })
    };
                    ...
                    <Table>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell >请求路由</TableCell>
                                <TableCell >请求方式</TableCell>
                                <TableCell >请求耗时</TableCell>
                                <TableCell >请求状态</TableCell>
